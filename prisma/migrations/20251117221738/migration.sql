...
-- AddForeignKey
ALTER TABLE "EventPeople" ADD CONSTRAINT "id_event_fk" FOREIGN KEY ("id_event") REFERENCES "Event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EventPeople" ADD CONSTRAINT "id_eventPeople_fk" FOREIGN KEY ("id_event") REFERENCES "EventGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
